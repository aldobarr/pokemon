...
import Game, { IScale, SkipSprite } from "../Game";
	...
	handleGrass() {
		...
		if (movingTo != null) {
			...
			animatedGrass.onComplete = () => {
				...
				if (
					this.last_animated_grass &&
					this.last_animated_grass.coords.x === animatedGrass.coords.x &&
					this.last_animated_grass.coords.y === animatedGrass.coords.y
				) {
